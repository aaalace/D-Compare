...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_filter.setStyleSheet("background-color: orange; color: white; border-radius: 20px")
        ...
        self.btn_all.setStyleSheet("background-color: orange; color: white; border-radius: 20px")
        ...
        self.menu_3.setStyleSheet("color: green;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_3.setTitle(_translate("MainWindow", "Обзоры и рекомендации"))
