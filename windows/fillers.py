...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_del.setGeometry(QtCore.QRect(480, 660, 111, 31))
        font = QtGui.QFont()
