...
class Main_Form(object):
    def setupUi(self, MainWindow):
        ...
        self.list_characts = QtWidgets.QListWidget(self.tab_basket)
        self.list_characts.setGeometry(QtCore.QRect(60, 120, 1801, 851))
        self.list_characts.setStyleSheet("background-color: white")
        self.list_characts.setObjectName("list_characts")
