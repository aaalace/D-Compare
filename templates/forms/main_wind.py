...
class Main_Form(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 1991, 1141))
        font = QtGui.QFont()
        ...
        self.label_login.setGeometry(QtCore.QRect(900, 300, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_login.setFont(font)
        self.label_login.setObjectName("label_login")
        self.line_login = QtWidgets.QLineEdit(self.tab)
        self.line_login.setGeometry(QtCore.QRect(830, 340, 221, 31))
        ...
        self.label_password.setGeometry(QtCore.QRect(900, 420, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_password.setFont(font)
        self.label_password.setObjectName("label_password")
        self.line_password = QtWidgets.QLineEdit(self.tab)
        self.line_password.setGeometry(QtCore.QRect(830, 460, 221, 31))
        ...
        self.radio_update.setGeometry(QtCore.QRect(1080, 460, 131, 31))
        self.radio_update.setObjectName("radio_update")
        self.btn_update = QtWidgets.QPushButton(self.tab)
        self.btn_update.setGeometry(QtCore.QRect(870, 650, 141, 41))
        self.btn_update.setStyleSheet("background-color: #FF6600; color: white; border-radius: 10px")
        self.btn_update.setObjectName("btn_update")
        self.line_new = QtWidgets.QLineEdit(self.tab)
        self.line_new.setGeometry(QtCore.QRect(830, 600, 221, 31))
        self.line_new.setStyleSheet("background-color: white; color: black")
        self.line_new.setObjectName("line_new")
        self.label_new = QtWidgets.QLabel(self.tab)
        self.label_new.setGeometry(QtCore.QRect(850, 560, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_new.setText(_translate("MainWindow", "Новый пароль"))
